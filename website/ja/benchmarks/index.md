...
<div class="summary-cards">
  <div class="summary-card">
    ...
    <div class="card-sub">マルチパス、2 × 100 Mbit / 25 ms</div>
  ...
  <div class="summary-card">
    ...
    <div class="card-sub">マルチパス / ダイレクト、2 × 100 Mbit / 25 ms</div>
    <div class="card-meta"><code>{{ push.tcpProxyRows.value[0]?.commit ?? '' }}</code> · {{ push.tcpProxyRows.value[0]?.date ?? '' }}</div>
  </div>
  <div class="summary-card">
    <div class="card-label">MITM H2 スループット</div>
    <div class="card-value">{{ push.mitmRows.value[0]?.multipath ?? '—' }} <span class="unit">Mbps</span></div>
    <div class="card-sub">マルチパス、2 × 100 Mbit / 25 ms、tproxy</div>

 ...
 * line (mq.path worst case ≈265 B with 10 numeric fields including min_rtt_ms,
 * cwnd, and inflight; 320 cap gives ~55 B headroom for future fields). */
#define MQ_METRICS_LINE_CAP 320
